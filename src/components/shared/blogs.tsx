...
export const Blogs: React.FC<Props> = ({ className }) => {
    ...
    return (
        <section className={cn('w-full flex flex-col items-center py-4 bg-zinc-100', className)}>
                ...
                <div className={cn('w-full p-1', className)}>
                    <div className={cn('relative w-full h-full rounded-xl overflow-hidden', className)}>
                        ...
                        <div className={cn('absolute bottom-0 w-full bg-black/60 backdrop-blur-[6px] py-2 md:py-3 px-4 md:px-6', className)}>
                            <p className={cn('text-background text-xl md:text-3xl font-medium py-1', className)}>Design in the Age og AI: how to adapt lazily</p>
                            ...
                            <div className={cn('pt-2 md:flex md:items-end justify-between', className)}>
                                <div className={cn('w-full max-w-sm flex *:w-full py-1', className)}>
                                    <div>
                                        <div>
                                            <div className="group inline-block cursor-pointer">
                                                <div className={cn('relative w-9 h-9 border py-1 border-white sm:border-zinc-100 group-hover:border-white rounded-full overflow-hidden', className)}>
                                                    <Image src={"/introduction-image-1.jpg"} className={cn('object-cover', className)} fill alt={""} />
                                                </div>
                                    ...
                                    <div>
                                        <div>
                                            <div className="group inline-block cursor-pointer">
                                                <div className={cn('relative w-9 h-9 border py-1 border-white sm:border-zinc-100 group-hover:border-white flex items-center justify-center rounded-full overflow-hidden', className)}>
