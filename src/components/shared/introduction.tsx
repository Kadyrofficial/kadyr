...
export const Introduction: React.FC<Props> = ({ className }) => {
    ...
    return (
        <section className={cn('h-[calc(100vh-48px)] p-2', className)}>
            <div className={cn(' rounded-xl w-full h-full', className)}>
                ...
                <div className={cn('p-4 *:py-2', className)}>
                    ...
                    <p className={cn('', className)}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos</p>
